...
const steps = [
  { num: "01", title: "Upload Your Study Material", desc: "Import notes, slides, PDFs, articles, or textbook photos. Reviso AI reads and understands all your study materials instantly." },
  { num: "02", title: "AI Creates Flashcards", desc: "Smart question-answer pairs generated by AI, organized by topic and difficulty. Edit, customize, or regenerate any flashcard." },
  { num: "03", title: "Study with Spaced Repetition", desc: "Short daily review sessions powered by spaced repetition science. Watch your knowledge retention and exam scores climb." },
]
