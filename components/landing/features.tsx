...
const features = [
  { num: "01", icon: Sparkles, title: "AI Flashcard Generation", desc: "Paste notes or articles. Reviso AI extracts key concepts and creates optimized flashcards automatically for faster learning.", badge: "Save hours of manual work" },
